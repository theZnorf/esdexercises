...
##
#
# from : http://svn.tanoshi.net/libtanoshi/trunk/svn2cl.pl
#
...
#
# svn log --revision 7:1 | perl trunk\src\main\resources\svn2cl.pl >Changes
#
##
...
my %hackers = (
    "anozaki"     => "Akito Nozaki <anozaki\@tanoshi.net>",
);
