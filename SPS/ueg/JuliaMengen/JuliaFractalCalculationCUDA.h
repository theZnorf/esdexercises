...
namespace julia
{
    ...
    public:
        virtual void Calc(pfc::complex<FloatingType> const & c) override
        {
            ...
            // start calculation
            FractalCalculationWrapper(blockDimension, cThreadPerBlock, c, dp_image, mBitMap.get_num_pixels(),
        ...
        CUDA_ATTR_HOST_DEVICE static void CalcPixel(uint3 const blockIdx, dim3 const blockDim,
