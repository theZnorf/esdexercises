...
// includes
#include "helper-functions.h"  // helper for shared functions common to CUDA Samples
#include "helper-cuda.h"       // helper functions for CUDA error checking and initialization
